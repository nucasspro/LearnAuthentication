import { AlertCircle, CheckCircle2, Clock, Copy, Key, QrCode, RefreshCw, Shield, Smartphone } from 'lucide-react';
...
export default function MFADemo() {
  ...
  const progressColor = timeRemaining > 20 ? 'from-green-500 to-emerald-600' :
                        timeRemaining > 10 ? 'from-yellow-500 to-amber-600' :
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="text-center mb-8 md:mb-12">
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 dark:text-white">MFA/2FA Demo</h1>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 md:p-8">
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950 dark:to-amber-950 rounded-xl p-5 border-2 border-orange-200 dark:border-orange-800">
                <h3 className="font-semibold text-gray-800 dark:text-white mb-3 text-sm md:text-base">What is MFA?</h3>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-5 border-2 border-blue-200 dark:border-blue-800">
                <h3 className="font-semibold text-gray-800 dark:text-white mb-3 text-sm md:text-base">TOTP Explanation</h3>
              ...
              <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-5 border-2 border-green-200 dark:border-green-800">
                <h3 className="font-semibold text-gray-800 dark:text-white mb-3 text-sm md:text-base">How Setup Works</h3>
              ...
              <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-5 border-2 border-purple-200 dark:border-purple-800">
                <h3 className="font-semibold text-gray-800 dark:text-white mb-3 text-sm md:text-base">Compatible Apps</h3>
                <div className="flex flex-wrap gap-2">
                  {['Google Authenticator', 'Authy', '1Password', 'Microsoft Authenticator'].map((app) => (
                    <span key={app} className="px-3 py-1 bg-purple-600 dark:bg-purple-700 text-white rounded-full text-xs font-semibold">
                      {app}
                    </span>
                  ))}
                </div>
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950 dark:to-amber-950 rounded-xl p-5 border-2 border-orange-200 dark:border-orange-800">
                  <h3 className="font-semibold text-gray-800 dark:text-white mb-4 flex items-center gap-2 text-sm md:text-base">
                    <span className="w-6 h-6 bg-orange-600 dark:bg-orange-700 text-white rounded-full flex items-center justify-center text-xs font-bold">1</span>
                    Generate Secret
                  </h3>
                  {!secretGenerated ? (
                    <button
                      onClick={generateSecret}
                      className="w-full bg-orange-600 hover:bg-orange-700 text-white font-semibold py-3 rounded-xl transition-colors flex items-center justify-center gap-2 text-sm"
                    >
                    ...
                    <div className="bg-green-50 dark:bg-green-900/20 border border-green-300 dark:border-green-700 rounded-lg p-3">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-semibold text-green-800 dark:text-green-300">Secret Generated</span>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        >
                          {copiedItem === 'secret' ? <CheckCircle2 className="w-3 h-3" /> : <Copy className="w-3 h-3" />}
                        </button>
                      </div>
                    </div>
                  )}
                ...
                {secretGenerated && (
                  <>
                    <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-5 border-2 border-blue-200 dark:border-blue-800">
                      <h3 className="font-semibold text-gray-800 dark:text-white mb-4 flex items-center gap-2 text-sm md:text-base">
                        <span className="w-6 h-6 bg-blue-600 dark:bg-blue-700 text-white rounded-full flex items-center justify-center text-xs font-bold">2</span>
                        Scan QR Code
                      </h3>
                    ...
                    <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-5 border-2 border-amber-200 dark:border-amber-800">
                      <h3 className="font-semibold text-gray-800 dark:text-white mb-3 flex items-center gap-2 text-sm md:text-base">
                        <span className="w-6 h-6 bg-amber-600 dark:bg-amber-700 text-white rounded-full flex items-center justify-center text-xs font-bold">3</span>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        >
                          {copiedItem === 'manual' ? <CheckCircle2 className="w-3 h-3" /> : <Copy className="w-3 h-3" />}
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-5 border-2 border-green-200 dark:border-green-800">
                      <h3 className="font-semibold text-gray-800 dark:text-white mb-3 text-sm md:text-base">
                        <span className="w-6 h-6 bg-green-600 dark:bg-green-700 text-white rounded-full inline-flex items-center justify-center text-xs font-bold mr-2">4</span>
                        Verify Code
                      </h3>
                      ...
                      {error && (
                        <div className="bg-red-50 dark:bg-red-900/20 border-2 border-red-200 dark:border-red-800 rounded-xl p-3 flex items-center gap-3 mb-4">
                      ...
                      {isVerified && (
                        <div className="bg-green-50 dark:bg-green-900/20 border-2 border-green-200 dark:border-green-800 rounded-xl p-3 flex items-center gap-3 mb-4">
                          <CheckCircle2 className="w-4 h-4 text-green-600 dark:text-green-400 flex-shrink-0" />
                          <p className="text-xs text-green-800 dark:text-green-300">Code verified! MFA setup complete.</p>
                        </div>
                      )}
                      ...
                      <div className="flex gap-3">
                        ...
                        <button
                          ...
                          className="px-6 py-3 bg-green-600 hover:bg-green-700 disabled:bg-gray-400 text-white font-semibold rounded-xl transition-colors disabled:cursor-not-allowed text-sm"
                        >
                          Verify
                        </button>
                      </div>
            ...
            {step === 'verified' && (
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-2 border-green-300 dark:border-green-700 rounded-xl p-6 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-green-800 dark:text-green-300 mb-2">MFA Enabled!</h3>
                ...
                <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-5 border-2 border-amber-200 dark:border-amber-800">
                  ...
                  <div className="grid grid-cols-2 gap-2 max-h-48 overflow-y-auto">
                    {recoveryCodes.map((code, index) => (
                      <div key={index} className="bg-white dark:bg-gray-700 rounded-lg p-2 flex items-center justify-between gap-2">
                        <code className="text-xs font-mono text-gray-800 dark:text-gray-200">{code}</code>
                        <button
                ...
                <button
                  ...
                  className="w-full bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold py-3 rounded-xl hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors text-sm"
                >
                  Start Over
                </button>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950 dark:to-amber-950 rounded-xl p-6 border-2 border-orange-200 dark:border-orange-800">
                <div className="text-center mb-6">
                  ...
                  <div className="text-sm font-semibold text-gray-700 dark:text-gray-300">admin@example.com</div>
                </div>
                ...
                <div className="text-center mb-6">
                  ...
                  >
                    {copiedItem === 'totp' ? <CheckCircle2 className="w-4 h-4" /> : <Copy className="w-4 h-4" />}
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-semibold text-orange-600 dark:text-orange-400">{timeRemaining}s</span>
                  </div>
                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3 overflow-hidden">
                    <div
                      className={`bg-gradient-to-r ${progressColor} h-full transition-all duration-1000 ease-linear`}
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-5 border-2 border-blue-200 dark:border-blue-800">
                <h3 className="font-semibold text-gray-800 dark:text-white mb-3 text-sm">How It Works</h3>
